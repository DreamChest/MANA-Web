Rails.application.routes.draw do
  ...
  # Sources
  get '/sources/update', to: 'sources#update_all', as: 'update_sources'
  resources :sources
  get '/sources/:id/entries', to: 'sources#entries', as: 'source_entries'
  get '/sources/:id/update', to: 'sources#update_entries', as: 'update_source'
